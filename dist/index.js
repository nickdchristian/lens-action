...
async function run() {
    try {
        ...
        const trackDoraInput = core.getInput('track_dora');
        ...
        const chartConfigsInput = core.getInput('chart_configs');
        const parsedChartConfigs = (0, utils_1.parseMultilineDictionary)(chartConfigsInput);
